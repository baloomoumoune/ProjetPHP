...
<nav style="margin-top: 20px;">
  <a href="../index.php" class="nav-item is-active" data-active-color="orange" data-target="Bienvenue">Bienvenue <?php echo htmlspecialchars($_SESSION['prenom']); ?></a>
  ...
  <a href="../controleur/gestionOeuvre.php" class="nav-item" data-active-color="rebeccapurple" data-target="Gérer oeuvres">Gestion</a>
