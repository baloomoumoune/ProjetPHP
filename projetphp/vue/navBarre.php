...
<nav style="margin-top: 20px;">
  ...
  <a href="index.php?page=formulaireConnexion" class="nav-item" data-active-color="black" data-target="Se connecter" style="margin-left: auto;">Se connecter</a> <!-- Lien "Se connecter" à droite -->
</nav>
</body>
</html>
